/*
	...
	GLEDOPTO ZigBee RGB+CCT Controller GL-C-008
	by Eden Nelson (@edennelson)
	
	NOT for GLEDOPTO RGBW 1ID or 2ID Controllers.
	...
	version 1.0 - 
		It works... I'm not sure if I'm going to work on this past just making it work and it is.
		Known issue where strip turns off under 15 percent but will relight with on button.

*/

metadata {
    definition (name: "GLEDOPTO ZigBee RGB+CCT Light", namespace: "edennelson", author: "Eden Nelson") {
